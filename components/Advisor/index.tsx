...
const advisorData: Advisor[] = [
  {
    id: 1,
    name: "Dr. Onkar",
    btnText: "Principle project scientist IIT Madras",
    image: "/images/testimonials/auth-01.png",
  },
  {
    id: 2,
    name: "Akhil Tripathi",
    btnText: "Message him now",
  ...
  return (
    <section className="relative z-10 bg-primary/[.03] py-16 md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle title="Meet Your Mentors" paragraph=" " center={false} />

        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
          {advisorData.map((advisor) => (
            <SingleAdvisor key={advisor.id} advisor={advisor} />
          ))}
        </div>
      </div>
